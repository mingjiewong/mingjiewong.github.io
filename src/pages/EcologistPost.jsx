...
export default function EcologistPost() {
  const base = `${import.meta.env.BASE_URL || "/"}ecologist-ai/`;
  ...
  return (
    <PageLayout showBackLink={true} className="text-[20px]">
      <article className="prose dark:prose-invert max-w-none">
        ...
        <img
          src={`${base}blog_hero.jpg`}
          alt="Ecologist AI Wildlife Identifier"
          className="w-full h-auto rounded-xl border border-[var(--border)] shadow-lg mb-8"
        />
          <p className="text-center italic text-[15px] mt-2">
            Illustration generated by AI (ChatGPT).
          </p>
